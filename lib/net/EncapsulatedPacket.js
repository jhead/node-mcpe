...
class EncapsulatedPacket extends Packet {
  ...
  constructor(id = 0, { data = null, fields = { }, sequenceNumber = 0, reliability = 0, messageIndex = 0, ackNeeded = false, fragmented = false, fragmentIndex = 0, fragmentCount = 0, fragmentID = 0, orderIndex = 0, orderChannel = 0 } = { }) {
    super(id, data);
