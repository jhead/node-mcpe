...
class EncapsulatedPacket extends Packet {
  ...
  constructor(id = 0, { data = null, fields = { }, reliability = 0, messageIndex = 0, fragmented = false, fragmentIndex = 0, fragmentCount = 0, fragmentID = 0, orderIndex = 0, orderChannel = 0 } = { }) {
    super(id, data);
  ...
  static decode(buffer) {
    ...
    buffer.readIntBE(offset, 3); // RakNet Sequence Number
    offset += 3;
